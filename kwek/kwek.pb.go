...
func (x *Kwek) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Kwek) ProtoMessage() {}

func (x *Kwek) ProtoReflect() protoreflect.Message {
	mi := &file_kwek_proto_msgTypes[0]
...
// Deprecated: Use Kwek.ProtoReflect.Descriptor instead.
func (*Kwek) Descriptor() ([]byte, []int) {
	return file_kwek_proto_rawDescGZIP(), []int{0}
}

func (x *Kwek) GetText() string {
	if x != nil {
		return x.Text
	}
	return ""
...
func (x *Kwek) GetPostedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.PostedAt
	}
	return nil
...
var file_kwek_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x6c, 0x0a, 0x04, 0x4b, 0x77, 0x65, 0x6b, 0x12, 0x12,
	0x0a, 0x04, 0x74, 0x65, 0x78, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x74, 0x65,
	0x78, 0x74, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x37, 0x0a, 0x09, 0x70,
	0x6f, 0x73, 0x74, 0x65, 0x64, 0x5f, 0x61, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a,
	...
	0x6f, 0x6d, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6f, 0x6c, 0x70, 0x6c, 0x65, 0x78, 0x2d, 0x73, 0x36,
	0x2f, 0x6b, 0x77, 0x65, 0x6b, 0x6b, 0x65, 0x72, 0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75,
...
var file_kwek_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_kwek_proto_goTypes = []interface{}{
	(*Kwek)(nil),                  // 0: kwekker.Kwek
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_kwek_proto_depIdxs = []int32{
	1, // 0: kwekker.Kwek.posted_at:type_name -> google.protobuf.Timestamp
